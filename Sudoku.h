...
const int SQ4[18] = {4,1, 4,2, 4,3, 5,1, 5,2, 5,3, 6,1, 6,2, 6,3};	// |-----|-----|-----|
const int SQ5[18] = {4,4, 4,5, 4,6, 5,4, 5,5, 5,6, 6,4, 6,5, 6,6};	// | SQ4 | SQ5 | SQ6 |
const int SQ6[18] = {4,7, 4,8, 4,9, 5,7, 5,8, 5,9, 6,7, 6,8, 6,9};	// |-----|-----|-----|
